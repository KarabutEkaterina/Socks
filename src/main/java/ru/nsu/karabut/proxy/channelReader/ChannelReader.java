package ru.nsu.karabut.proxy.channelReader;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import ru.nsu.karabut.proxy.channelClient.SocksClient;
import ru.nsu.karabut.proxy.channelClient.SocksClientState;
import ru.nsu.karabut.proxy.dnsResolver.DnsResolver;
import ru.nsu.karabut.proxy.messages.connectionMessages.AddressType;
import ru.nsu.karabut.proxy.messages.connectionMessages.ConnectionMsg;
import ru.nsu.karabut.proxy.messages.connectionMessages.RequestCode;
import ru.nsu.karabut.proxy.messages.connectionMessages.ResponseCode;
import ru.nsu.karabut.proxy.messages.greetingMessage.AuthMethod;
import ru.nsu.karabut.proxy.messages.greetingMessage.GreetingMessage;
import ru.nsu.karabut.proxy.channelAttacments.ChannelAttachment;
import ru.nsu.karabut.proxy.channelAttacments.ChannelRole;
...
public class ChannelReader {
    ...
    private void processReadState(boolean isSmtRead, SocketChannel socketChannel, SocksClient socksClient, SelectionKey selectionKey) throws IOException {
        ...
        if (state == SocksClientState.RECV_INIT_GREETING) {
            greet(socketChannel, socksClient);
        } else if (state == SocksClientState.RECV_CONN_REQ) {
            processConnectionRequest(socketChannel, socksClient, selectionKey);
        } else if (state == SocksClientState.ACTIVE) {
